...
} catch (Exception $e) { error_log("Error fetching location data for ASP: " . $e->getMessage()); }
...
} catch (Exception $e) { error_log("Error fetching calendar data in asp_kalender.php: " . $e->getMessage()); }
$conn->close();
    ...
    function openDailyCalendarModal(cellDate) {
        ...
        dailyCalendarInstance = new FullCalendar.Calendar(dailyCalendarEl, {
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                ...
                const url = `asp_kalender_api.php?gedung_id=${selectedGedung}&lantai_id=${selectedLantai}`;
                fetch(url)
