...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_gedung'])) {
        ...
        if ($gedung_nama !== null && $gedung_nama !== '') { // Cek tidak null dan tidak string kosong
            ...
            // Pesan error jika nama gedung kosong
    ...
    if (isset($_POST['add_lantai'])) {
        ...
        if ($lantai_nomor !== null && $lantai_nomor !== '' && !empty($gedung_id)) { // Cek $lantai_nomor tidak null/kosong
            ...
            // Pesan error jika data tidak lengkap
    ...
    if (isset($_POST['add_ruangan'])) {
        ...
        if ($ruangan_nama !== null && $ruangan_nama !== '' && !empty($lantai_id)) { // Cek $ruangan_nama tidak null/kosong
    ...
    if (isset($_POST['delete_ruangan'])) {
        ...
        // [FIX] Tambahkan cek ke jadwal_kelas juga, dibungkus transaksi
        $conn->begin_transaction();
        try {
            // Cek di peminjaman_ruangan
...
// Query diubah untuk sorting yang lebih baik (natural sort)
                    ...
                    <div class="form-section">
                        ...
                        <form action="asp_kelolaRuangan.php" method="POST">
                            <div class="form-group">
                                <label for="gedung_nama_asp">Nama Gedung</label>
                                <input type="text" id="gedung_nama_asp" name="gedung_nama" placeholder="Contoh: Gedung 10" required>
                            </div>
            ...
            <div id="lantai" class="tab-content <?php if($active_tab == 'lantai') echo 'active'; ?>">
                 <div class="content-grid">
                    <div class="form-section">
                        ...
                        <form action="asp_kelolaRuangan.php" method="POST">
                            <div class="form-group">
                                <label for="gedung_id_for_lantai_asp">Pilih Gedung</label>
                                <select id="gedung_id_for_lantai_asp" name="gedung_id_for_lantai" required>
                            ...
                            <div class="form-group">
                                <label for="lantai_nomor_asp">Nomor/Nama Lantai</label>
                                <input type="text" id="lantai_nomor_asp" name="lantai_nomor" placeholder="Contoh: 1 atau G" required>
                            </div>
                ...
                <div class="content-grid">
                    <div class="form-section">
                        ...
                        <form action="asp_kelolaRuangan.php" method="POST">
                            ...
                            <div class="form-group">
                                <label for="ruangan_nama_asp">Langkah 3: Nama/Nomor Ruangan</label>
                                <input type="text" id="ruangan_nama_asp" name="ruangan_nama" placeholder="Contoh: R10317" required>
                            </div>
