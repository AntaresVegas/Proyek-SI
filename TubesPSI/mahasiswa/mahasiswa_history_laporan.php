...
if ($user_id !== 'No ID') {
    try {
        ...
        error_log("Error counting history laporan: " . $e->getMessage());
    }
}
...
<div class="content-wrapper">
    <div class="container">
        ...
        <?php if ($total_pages > 1 && !empty($laporan_pertanggungjawaban)): ?>
        <div class="pagination-container">
            <div class="pagination-info">
                Menampilkan <strong><?php echo count($laporan_pertanggungjawaban); ?></strong> dari <strong><?php echo $total_rows; ?></strong> data
            </div>
