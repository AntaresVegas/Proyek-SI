...
<div class="container">
    <div class="header">
        ...
        <a href="mahasiswa_history.php" class="detail-button" style="background-color: #6c757d;">Kembali</a>
    </div>
            ...
            <?php if (!empty($pengajuan_events)): ?>
                <?php foreach ($pengajuan_events as $event): ?>
                    <tr>
                        ...
                        <td>
                            <a href="mahasiswa_detail_pengajuan.php?id=<?php echo $event['pengajuan_id']; ?>" class="detail-button">DET</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="3" class="no-data">Belum ada pengajuan event.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
