...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // ---- LOGIKA POST UNTUK TAMBAH/HAPUS (TIDAK BERUBAH) ----
...
<script>
    ...
    // --- LOGIKA UNTUK KARTU KELOLA LANTAI ---
    ...
    filterGedungLantai.addEventListener('change', function() {
        ...
        // 1. Update hidden input untuk form tambah lantai
        hiddenGedungIdLantai.value = selectedGedung;
        
        // 2. Filter tabel lantai
    ...
    // --- LOGIKA UNTUK KARTU KELOLA RUANGAN ---
    ...
    // Saat Gedung di filter Ruangan berubah
    filterGedungRuangan.addEventListener('change', function() {
        ...
        // Update hidden input untuk form tambah ruangan menjadi kosong
        hiddenLantaiIdRuangan.value = "";

        // Filter tabel ruangan berdasarkan gedung saja
    ...
    // Saat Lantai di filter Ruangan berubah
    filterLantaiRuangan.addEventListener('change', function() {
        ...
        // 1. Update hidden input untuk form tambah ruangan
        hiddenLantaiIdRuangan.value = selectedLantai;

        // 2. Filter tabel ruangan berdasarkan lantai
        for (let row of tableBodyRuangan) {
            // Hanya proses baris yang sesuai dengan gedung yang terpilih
