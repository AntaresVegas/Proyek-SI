...
try {
    ...
    if ($stmt) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $events[] = [
                ...
                'backgroundColor' => '#27ae60', // Warna hijau dari legenda
                'borderColor'     => '#27ae60'
            ];
            ...
            if (!empty($row['tanggal_persiapan'])) {
                ...
                if ($prep_start_dt < $main_start_dt) {
                    ...
                    $events[] = [
                        ...
                        'end'             => $prep_end_date,
                        'allDay'          => true,
                        'backgroundColor' => '#dc3545', // Warna merah dari legenda
                        'borderColor'     => '#dc3545'
                    ];
                }
            }
    ...
    error_log("Error in ditmawa_kalender_api.php: " . $e->getMessage());
}
