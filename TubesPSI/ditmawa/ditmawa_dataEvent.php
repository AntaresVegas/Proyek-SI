...
try {
    // [FIX] Query diubah agar SAMA seperti ASP/Sekretariat
    $stmt = $conn->prepare("
        SELECT 
    ...
    // ... (Sisa logika PHP untuk memproses $calendar_events tetap sama) ...
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ... (Fungsi updateLantaiFilter, updateModalLantaiFilter, renderFilteredCalendar, renderCalendar, setupEventListeners) ...
    ...
    function openDailyCalendarModal(cellDate) {
        ...
        dailyCalendarInstance = new FullCalendar.Calendar(dailyCalendarEl, {
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                ...
                const url = `ditmawa_kalender_api.php?gedung_id=${selectedGedung}&lantai_id=${selectedLantai}`;
                fetch(url)
