...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .data-table th, .data-table td { padding: 12px 15px; border: 1px solid #ddd; vertical-align: middle; text-align: left; }
...
<div class="main-content">
    <div class="container">
        <div class="laporan-header"><h1>Kelola Laporan Pertanggungjawaban</h1></div>
                ...
                <?php if (!empty($laporan_data)): ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><span class="status-badge <?php echo $status_class; ?>"><?php echo htmlspecialchars($row['pengajuan_statusLPJ']); ?></span></td>
                            <td>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="6" class="no-data-message">Belum ada LPJ yang diunggah oleh mahasiswa.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
