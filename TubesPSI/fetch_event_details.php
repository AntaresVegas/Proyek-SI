...
try {
    // PERBAIKAN: Menggunakan LEFT JOIN agar event tetap tampil meski data lokasi tidak lengkap
    $sql = "
        SELECT 
    ...
    if ($stmt) {
        ...
        while ($row = $result->fetch_assoc()) {
            // PERBAIKAN: Menggabungkan data lokasi menjadi satu string yang rapi
            $lokasi_parts = [];
