<?php
// File: sekretariat_kalender_api.php
...
try {
    ...
    "; // <-- DIKEMBALIKAN ke status_proposal
    ...
    if ($stmt) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $events[] = [
                ...
                'backgroundColor' => '#17a2b8', // Warna dari legenda
                'borderColor'     => '#17a2b8'
            ];
            ...
            if (!empty($row['tanggal_persiapan'])) {
                ...
                if ($prep_start_dt < $main_start_dt) {
                    ...
                    $events[] = [
                        ...
                        'end'             => $prep_end_date,
                        'allDay'          => true,
                        'backgroundColor' => '#6c757d', // Warna dari legenda
                        'borderColor'     => '#6c757d'
                    ];
                }
            }
    ...
    error_log("Error in sekretariat_kalender_api.php: " . $e->getMessage());
}
